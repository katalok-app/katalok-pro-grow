...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Turn your phone gallery into a beautiful online Katalok. Showcase your work, get discovered locally, and grow your beauty business." },
      { property: "og:title", content: "Katalok — Your Beauty Portfolio. Beautifully Organized." },
      { property: "og:description", content: "Don't just save your work. Showcase it. Build your digital beauty catalog on Katalok." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Katalok — Your Beauty Portfolio. Beautifully Organized." },
      { name: "twitter:description", content: "Don't just save your work. Showcase it. Build your digital beauty catalog on Katalok." },
